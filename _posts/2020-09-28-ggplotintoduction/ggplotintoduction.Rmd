...
Cette première séance a porté sur la création de graphique avec `ggplot`. [Les slides sont disponibles](https://marieetienne.github.io/courses/Visualisation/visu_ggplot.html) et [le code](https://raw.githubusercontent.com/MarieEtienne/courses/master/Visualisation/visu_ggplot.Rmd) utilisé est également disponible. 

Les packages nécessairespeuvebnt être installés par les commandes suivantes :
